...
<head>
    ...
    <title>Novedades Maritex | Login</title>
    ...
    <div id="app">
        <div class="limiter">
                    ...
                    <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
                        <div class="container">
                            <a class="navbar-brand" href="{{ url('/') }}">
                                <i class="fa fa-university"></i><span>Novedades Maritex</span>
                            </a>
                                    ...
                                    @else
                                        <li class="nav-item dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                                <a class="dropdown-item" href="{{URL::to('/bienvenido')}}">
                                                    {{ __('Return') }}
                                                </a>
            ...
            <footer class="text-center">
                <p>©2020 All Rights Reserved. Novedades Maritex Privacy and <a href="#">terms</a></p>
            </footer>
        </div>
    </div>
