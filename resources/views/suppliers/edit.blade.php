...
@section('contenido')
    ...
    <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
            ...
            <div class="x_content">
                <form method="POST" action="{{ route('suppliers.update',$supplier->supp_id) }}">
                    @method('put')
                    @csrf
                    <div id="wizard" class="form_wizard wizard_horizontal">
                        ...
                        <div id="step-1">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="supp_dni" name="supp_dni"  class="form-control" value="{{$supplier->supp_dni}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-1 col-sm-1 ">
                                    <select class="form-control" name="supp_contact_title" id="supp_contact_title">
                                        ...
                                        <option value="Sr." {{$supplier->supp_contact_title == 'Sr.' ? 'selected' : ''}}>Sr.</option>
                                        <option value="Sra." {{$supplier->supp_contact_title == 'Sra.' ? 'selected' : ''}}>Sra.</option>
                                    </select>
                                </div>
                                <div class="col-md-5 col-sm-5 ">
                                    <input type="text" id="supp_contact_name" name="supp_contact_name" required="required" class="form-control" value="{{$supplier->supp_contact_name}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="supp_phone" name="supp_phone" required="required" class="form-control" value="{{$supplier->supp_phone}}">
                                </div>
                            </div>
                        ...
                        <div id="step-2">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="supp_address" name="supp_address" required="required" class="form-control" value="{{$supplier->supp_address}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="supp_city" name="supp_city" required="required" class="form-control" value="{{$supplier->supp_city}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="supp_region" name="supp_region" required="required" class="form-control" value="{{$supplier->supp_region}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="supp_country" name="supp_country" required="required" class="form-control" value="{{$supplier->supp_country}}">
                                </div>
                            </div>
                        </div>
                        <div id="step-3">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="supp_companyname" name="supp_companyname" required="required" class="form-control" value="{{$supplier->supp_companyname}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="supp_ruc" name="supp_ruc" class="form-control" value="{{$supplier->supp_ruc}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="supp_homepage" name="supp_homepage" class="form-control" value="{{$supplier->supp_homepage}}">
                                </div>
                            </div>
