...
@section('contenido')
    <div class="col-md-12 col-sm-12 ">
        <div class="x_panel">
            <div class="x_title">
                <h2>Registrar <small>Mercadería</small></h2>
                    ...
                    <div id="wizard" class="form_wizard wizard_horizontal">
                        ...
                        <div id="step-1">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="prod_name" name="prod_name" required="required" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <textarea type="text" id="prod_description" name="prod_description" required="required" class="form-control"></textarea>
                                </div>
                            </div>
                        ...
                        <div id="step-2">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <select name="supp_id" id="supp_id" class="form-control select2 select2-hidden-accessible selectpicker" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true" data-live-search="true">
                                        ...
                                        @foreach ($suppliers as $supplier)
                                            <option value="{{$supplier->supp_id}}">{{$supplier->supp_contact_title}} {{$supplier->supp_contact_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="number" id="prod_stock" name="prod_stock" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    ...
                                    <button class="btn btn-default"  data-toggle="modal" data-target="#addsizes">  Agregar</button>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <!-- Button trigger modal -->
                                    <button class="btn btn-default"  data-toggle="modal" data-target="#addcolors">  Agregar</button>
                        ...
                        <div id="step-3">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="prod_purchase_price" name="prod_purchase_price" required="required" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="prod_sale_price" name="prod_sale_price" required="required" class="form-control">
                                </div>
                            </div>
                        </div>
                    </div>
